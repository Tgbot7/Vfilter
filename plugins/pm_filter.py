           ...
           if type == "document":
              await bot.send_document(
	            update.message.chat.id,
                       ...
                       caption=caption, 
                       progress=progress_for_pyrogram,
                       progress_args=( "**⎝⎝✧ ʀᴇᴄɪᴇᴠɪɴɢ ꜰɪʟᴇ ꜰʀᴏᴍ Sk ꜱᴇʀᴠᴇʀ ✧⎠⎠**",  ms, c_time))
           elif type == "video": 
...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/skcreator7/777'),
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @ꜱᴋᴄʀᴇᴀᴛᴏʀ7 ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You @ꜱᴋᴄʀᴇᴀᴛᴏʀ7 ♥️')
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('♥️ Thank You @ꜱᴋᴄʀᴇᴀᴛᴏʀ7 ♥️')
        ...
        await query.answer("Thank You @ꜱᴋᴄʀᴇᴀᴛᴏʀ7")
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🧑‍✈️ Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ 🧑‍✈️", url=f"https://telegram.me/SKadminrobot")
            ],[
                InlineKeyboardButton(text=f"🔴 Sᴜʙꜱᴄʀɪʙᴇ ʏᴛ Cʜᴀɴɴᴇʟ ◀️", url=f"https://youtube.com/@skcreator7")
        ...
        try:
            ...
            reply_markup_lzdv = InlineKeyboardMarkup(btn_lzdv) 
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"__**Yᴏᴜ Hᴀᴠᴇ Tʏᴘᴇᴅ Tʜᴇ Nᴀᴍᴇ Wʀᴏɴɢ. Pʟᴇᴀꜱᴇ Cʜᴇᴄᴋ Tʜᴇ Sᴘᴇʟʟɪɴɢ ❌`{movie}`❌ \n\nआपने नाम गलत टाइप किया है. कृपया स्पेलिंग जांचें.**__",, reply_markup=reply_markup)
        ...
        try:
            ...
            reply_markup_lzdv = InlineKeyboardMarkup(btn_lzdv)
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"__**Yᴏᴜʀ RᴇQᴜᴇꜱᴛ Aᴄᴄᴇᴘᴛᴇᴅ ✅**__  `{movie}`Movie \n\nआपका अनुरोध स्वीकार किया गया ✅\n\n♻ Pʟᴇᴀꜱᴇ Wᴀɪᴛ..♻", reply_markup=reply_markup)
    ...
    await query.answer('♥️ Thank You skcreator7 ♥️')
...
async def auto_filter(client, msg, spoll=False):
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝙷𝚎𝚢 𝚜𝚘𝚗𝚊 `{message.from_user.first_name}` 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ **ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ** !\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝𝘾𝙤𝙣𝙩𝙚𝙣𝙩 𝙣𝙖𝙢𝙚 : `{search}`\n➟ 👮𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮 : `{message.from_user.first_name}`\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @{ADMIN_USRNM}",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("CHECK REPORT", url=f'http://t.me/NEW_M0VIE_BOT')],[InlineKeyboardButton("╚»♥️ Thank You ♥️«╝", callback_data="close_data")]]))
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/skcreator7/777'),
        ] 
    )
    ...
    waiting_message = await message.reply_text(f"Searching your request {full_name}...")
    await asyncio.sleep(1)
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("❗Sᴘᴇʟʟɪɴɢ Mɪꜱᴛᴀᴋᴇ ❓\n       ᴏʀ     \n⚠️ Nᴏᴛ Aᴠᴀɪʟᴀʙʟᴇ")
        await asyncio.sleep(10)
        await k.delete()
        return
    ...
    await msg.reply("Sᴘᴇʟʟɪɴɢ Mɪꜱᴛᴀᴋᴇ Bʀᴏ ‼️ ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ 😊 Cʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴏɴᴇ ʙᴇʟᴏᴡ 👇",
                    reply_markup=InlineKeyboardMarkup(btn))
