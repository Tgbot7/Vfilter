...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            reply_markup_lzdv = InlineKeyboardMarkup(btn_lzdv) 
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"<b>Yᴏᴜ Hᴀᴠᴇ Tʏᴘᴇᴅ Tʜᴇ Nᴀᴍᴇ Wʀᴏɴɢ. Pʟᴇᴀꜱᴇ Cʜᴇᴄᴋ Tʜᴇ Sᴘᴇʟʟɪɴɢ ❌`{movie}`❌ \n\nआपने नाम गलत टाइप किया है. कृपया स्पेलिंग जांचें🧐</b>",, reply_markup=reply_markup)
        ...
        try:
            ...
            reply_markup_lzdv = InlineKeyboardMarkup(btn_lzdv)
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"<b>Yᴏᴜʀ RᴇQᴜᴇꜱᴛ Aᴄᴄᴇᴘᴛᴇᴅ ✅  `{movie}`Movie \n\nआपका अनुरोध स्वीकार किया गया ✅\n\n♻ Pʟᴇᴀꜱᴇ Wᴀɪᴛ..♻</b>", reply_markup=reply_markup)
