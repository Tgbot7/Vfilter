...
BOT_TOKEN = environ.get('BOT_TOKEN', "5905102389:AAE31QixBZC09pGmfskByucHB4RXbr-TIfA")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MANXXX:RENAMEBOT@cluster0.lfcfn2t.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001932188496))
LAZY_GROUP_LOGS = int(environ.get('LAZY_GROUP_LOGS', -1001988070722))
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5928972764').split()]
...
URL = "https://skcreator-da3337ac8e08.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://skcreator-da3337ac8e08.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://skcreator-da3337ac8e08.herokuapp.com/".format(FQDN)
else:
    URL = "https://skcreator-da3337ac8e08.herokuapp.com/".format(FQDN)
