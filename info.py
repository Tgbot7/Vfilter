...
URL = "https://lazy-kate-skcreator7.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lazy-kate-skcreator7.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lazy-kate-skcreator7.koyeb.app/".format(FQDN)
else:
    URL = "https://lazy-kate-skcreator7.koyeb.app/".format(FQDN)
