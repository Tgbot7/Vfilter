...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5928972764').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1001768249569').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5072166420').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MANXXX:RENAMEBOT@cluster0.tygvg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🎬<b>[{file_caption}](https://t.me/skfilmbox)</b>")
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5072166420').split()]
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Skfilmbox') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','+9BdGMNqn2DliYzZl') # WITHOUT @
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '9dGO9HXshhTQNEypqNWqgG7RC8t2')
...
DOWNLOAD_TEXT_URL = "https://t.me/sk_films_box"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/skfilmbox"
